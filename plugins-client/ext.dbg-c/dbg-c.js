...
var DebuggerService = require("ext/dbg-c/service");
...
(function() {
    this.$startDebugging = function() {
        console.log("=====$startDebugging===< dbg-c.js")
    };
    ...
    this.attach = function(pid, runner) {
        console.log("=====attach===< dbg-c.js")
	console.log(pid);

        var gdbCommand = runpanel.getEnvVariables().gdb;
        c9console.evalInputCommand(gdbCommand);

        //var pageId = tabConsole.getPage().$uniqueId;
        //console.log(pageId)
        //console.log(c9console.pageIdToPidMap[pageId].pid)
        //c9console.evalInputCommand("target remote 172.16.149.131:9000");
        //c9console.evalInputCommand("symbol-file remote:/home/qiu/test/gdb_remote");
        //if (this.$v8ds)
        //    this.$v8ds.disconnect();
        //this.pid = pid;
        //this.$v8ds = new DebuggerService(pid, runner, settings);
        //this.$v8ds.connect();
        //this.$startDebugging();
    ...
    this.detach = function() {
        //this.$v8ds.disconnect();
        //TODO console.js:1081
        c9console.killProcess();
        //this.$v8ds = null;
        //this.$v8dbg = null;
    ...
    this.onChangeRunning = function(e) {
        console.log("---onChangeRunning---<dbg-c.js")
    };

    this.onBreak = function(e) {
        console.log("------>onBreak<dbg-c.js")
    };

    this.onException = function(e) {
        console.log("------>onException<dbg-c.js")
    };

    this.onAfterCompile = function(e) {
        console.log("------>onAfterCompile<dbg-node.js")
    };

    this.onChangeFrame = function(frame, silent) {
        console.log("------>onChangeFrame<dbg-c.js")
    };
    ...
    this.updateBreakpoints = function(callback) {
        console.log("=====updateBreakpoints===< dbg-node.js ")
        var _self = this;
